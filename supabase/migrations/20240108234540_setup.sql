...
AS $$
DECLARE
  project_url TEXT := 'https://qztbphiiorkxmowsonnx.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InF6dGJwaGlpb3JreG1vd3Nvbm54Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwODc4NjAwMywiZXhwIjoyMDI0MzYyMDAzfQ.RDj9F4mz-rNtefzfsHjEomWixAqGqBLtB4Jcx-O5ua0'; -- full access needed for http request to storage
